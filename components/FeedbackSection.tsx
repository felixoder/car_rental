        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-8 mx-auto md:mx-0">
          <div className="relative profile_box w-[300px] md:w-[372px] h-[376px]">
            ...
            <div className="flex flex-col p[20px] mt-5">
              ...
              <p className='text-para-gray'>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type.
              </p>
            </div>
          </div>
          ...
          <div className="relative profile_box w-[300px] md:w-[372px] h-[376px]">
            ...
            <div className="flex flex-col p[20px] mt-5">
              ...
              <p className='text-para-gray'>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrystandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type.
              </p>
            </div>
          </div>
